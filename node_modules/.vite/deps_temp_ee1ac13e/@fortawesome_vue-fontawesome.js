...
function patchAttr(el, key, value, isSVG, instance, isBoolean = isSpecialBooleanAttr2(key)) {
  if (isSVG && key.startsWith("xlink:")) {
    ...
    if (value == null || isBoolean && !includeBooleanAttr2(value)) {
      el.removeAttribute(key);
    } else {
      el.setAttribute(
        key,
        isBoolean ? "" : isSymbol2(value) ? String(value) : value
      );
    }
  }
}
...
(function(module) {
  (function(global2) {
    ...
    var pascalize = function(string) {
      var camelized = camelize3(string);
    ...
    var humps2 = {
      ...
      camelizeKeys: function(object, options) {
        return _processKeys(_processor(camelize3, options), object);
      },
